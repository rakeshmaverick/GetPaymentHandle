...
import com.skyleaf.repository.ReturnLinkRepository;
...
public class PayementMethod {
	...
	public String readAll() {
		...
		//returnlink
		Iterable<ReturnLinks> returnKinks = returnLinkRepository.findAll();
		
		json = gson.toJson(returnKinks);
		res.put("returnKinks", new JSONArray(json));
